...
//   useEffect(() => {
//     // Fetch all pet shops on component mount
//     const fetchPetShops = async () => {
//       try {
//         const { data } = await axios.get("http://localhost:8000/api/petShops");
//         setPetShops(data);
//         setFilteredShops(data);
//       } catch (err) {
//         console.error("Failed to fetch pet shops", err);
//       }
//     };
//     fetchPetShops();
//   }, []);
...
//         `http://localhost:8000/api/petShops/category/${category}`
//       );
//       setFilteredShops(data);
//     } catch (err) {
...
//     if (searchQuery.trim() === "") {
//       setFilteredShops(petShops);
//       return;
//     }
//     try {
//       const { data } = await axios.get(
//         `http://localhost:8000/api/petShops/search?query=${searchQuery}`
//       );
//       setFilteredShops(data);
//     } catch (err) {
...
//       {/* Sidebar */}
//       <div className="w-1/4 bg-teal-700 p-4 flex flex-col space-y-4 text-white">
//         <h2 className="text-2xl font-bold">Categories</h2>
//         {["Medical Supplies", "Food Supplies", "Pet Accessories", "Grooming Services"].map(
//           (category) => (
//             <button
//               key={category}
//               className={`p-2 rounded-lg transition ${
//                 selectedCategory === category ? "bg-teal-900" : "bg-teal-600"
//               } hover:bg-teal-800`}
...
//           <input
//             type="text"
//             className="border-2 border-teal-400 rounded p-2 w-2/3"
//             placeholder="Search pet shops by name..."
//             value={searchQuery}
...
//             >
//               <h3 className="text-xl font-bold text-teal-700">{shop.name}</h3>
//               <p className="text-gray-700">{shop.description}</p>
//               <p className="text-gray-500">Location: {shop.location}</p>
//               <p className="text-gray-500">Contact: {shop.contact}</p>
//             </div>
//           ))}
//         </div>
//       </div>
...
//   useEffect(() => {
//     axios.get("http://localhost:8000/api/petShops").then((response) => {
...
//   return (
//     <div className="min-h-screen bg-[#0a1324] text-white flex flex-col px-20 py-10 gap-10">
//       {/* Search Bar */}
...
//           className="p-2 rounded-lg border-2 border-teal-400 bg-[#121e34] text-white focus:outline-none focus:ring focus:ring-teal-300"
//         />
//       </div>
...
const PetShops = () => {
  ...
  return (
    <div className="min-h-screen bg-[#0a1324] text-white flex px-20 py-10 gap-10">
      {/* Sidebar */}
