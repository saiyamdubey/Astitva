...
const PetShops = () => {
  ...
  useEffect(() => {
    axios.get("http://www.localhost:8000/api/petShops").then((response) => {
  ...
  return (
    <div className="min-[10rem] w-full lg:flex text-white lg:flex-row py-10 gap-5 ">
      <button
      ...
      {/* Main Content */}
      <div className="flex-1 flex flex-col gap-10 px-4 -mt-96 lg:mt-0 overflow-scroll-x">
        {/* Search Bar */}
