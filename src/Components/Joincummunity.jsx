...
const JoinCommunity = () => {
    return (
        <div className="bg-gradient-to-r pt-6 md:pt-12 px-4 h-[80vh] flex items-center justify-center">
            <div className="flex justify-around gap-6 md:gap-8 max-w-5xl w-full">
