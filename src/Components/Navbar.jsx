...
//   return (
//     <nav className="top-0 z-50 sticky w-screen">
...
import { Menu, X } from 'lucide-react';
import { Link, useNavigate, useLocation } from 'react-router-dom';
import { FaUserCircle } from 'react-icons/fa'; // React Icon for User Avatar
...
const Navbar = () => {
  ...
  return (
    <nav className="top-0 z-50 sticky w-full bg-teal-500 shadow-lg">
      <div className="font-bold text-neutral-800">
        <div className="flex justify-between items-center py-3 lg:px-20 px-10">
          ...
          <div className="hidden lg:flex list-none">
            <ul className="flex text-lg gap-6">
              {['/', '/adopt', '/shelters', '/petshops', '/aboutus'].map((path, index) => (
                <li key={index}>
                  <Link
                    to={path}
